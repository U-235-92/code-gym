...
public class Alert extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private aq.gym.brokers.kafka.simple_avro_example.AlertStatus status;
   ...
   */
  public Alert(java.lang.Long sensor_id, java.lang.Long time, aq.gym.brokers.kafka.simple_avro_example.AlertStatus status) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: status = (aq.gym.brokers.kafka.simple_avro_example.AlertStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public aq.gym.brokers.kafka.simple_avro_example.AlertStatus getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(aq.gym.brokers.kafka.simple_avro_example.AlertStatus value) {
    this.status = value;
  }
   ...
   */
  public static aq.gym.brokers.kafka.simple_avro_example.Alert.Builder newBuilder() {
    return new aq.gym.brokers.kafka.simple_avro_example.Alert.Builder();
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static aq.gym.brokers.kafka.simple_avro_example.Alert.Builder newBuilder(aq.gym.brokers.kafka.simple_avro_example.Alert.Builder other) {
    if (other == null) {
      return new aq.gym.brokers.kafka.simple_avro_example.Alert.Builder();
    } else {
      return new aq.gym.brokers.kafka.simple_avro_example.Alert.Builder(other);
    }
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static aq.gym.brokers.kafka.simple_avro_example.Alert.Builder newBuilder(aq.gym.brokers.kafka.simple_avro_example.Alert other) {
    if (other == null) {
      return new aq.gym.brokers.kafka.simple_avro_example.Alert.Builder();
    } else {
      return new aq.gym.brokers.kafka.simple_avro_example.Alert.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Alert>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(aq.gym.brokers.kafka.simple_avro_example.Alert.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(aq.gym.brokers.kafka.simple_avro_example.Alert other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.sensor_id)) {
        this.sensor_id = data().deepCopy(fields()[0].schema(), other.sensor_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public aq.gym.brokers.kafka.simple_avro_example.Alert.Builder setSensorId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aq.gym.brokers.kafka.simple_avro_example.Alert.Builder clearSensorId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public aq.gym.brokers.kafka.simple_avro_example.Alert.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aq.gym.brokers.kafka.simple_avro_example.Alert.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public aq.gym.brokers.kafka.simple_avro_example.Alert.Builder setStatus(aq.gym.brokers.kafka.simple_avro_example.AlertStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aq.gym.brokers.kafka.simple_avro_example.Alert.Builder clearStatus() {
      status = null;
    ...
    public Alert build() {
      try {
        ...
        record.status = fieldSetFlags()[2] ? this.status : (aq.gym.brokers.kafka.simple_avro_example.AlertStatus) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.status = aq.gym.brokers.kafka.simple_avro_example.AlertStatus.values()[in.readEnum()];
